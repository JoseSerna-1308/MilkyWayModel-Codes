void LindbladDiagramPlot_Bulge()
{
...
// j_serna@ciencias.unam.mx
  ...
  txt_A = "CircularOrbitCurve_Bulge.txt";
  txt_B = "Parabola_r1_Bulge.txt";
  txt_C = "Parabola_r2_Bulge.txt";
  txt_D = "Parabola_r3_Bulge.txt";
  txt_E = "Parabola_r4_Bulge.txt";
  txt_F = "Parabola_r5_Bulge.txt";
...
//  c1 -> SetGrid();
  ...
  leg -> AddEntry( A , "Curv Orb Circ (Bulge)" , "l" ) ;
  c1 -> Update() ;
