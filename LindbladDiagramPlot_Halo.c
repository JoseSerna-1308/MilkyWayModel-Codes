...
// j_serna@ciencias.unam.mx
  ...
  txt_A = "CircularOrbitCurve_Halo.txt";
  txt_B = "Parabola_r1_Halo.txt";
  txt_C = "Parabola_r2_Halo.txt";
  txt_D = "Parabola_r3_Halo.txt";
  txt_E = "Parabola_r4_Halo.txt";
  txt_F = "Parabola_r5_Halo.txt";
...
//  c1 -> SetGrid();
  ...
  A -> GetXaxis() -> SetLimits( -1500 , -1200 ) ;
  ...
  leg -> AddEntry( A , "Curv Orb Circ (Halo)" , "l" ) ;
  c1 -> Update() ;

  B -> SetLineStyle( 1 ) ;
  B -> SetLineColor( kCyan+0 ) ;
  B -> SetLineWidth( 2 ) ;
  B -> Draw( "C" ) ;
